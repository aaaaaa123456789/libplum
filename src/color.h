...
#define PLUM_RED_32(color) ((uint32_t) (color) & 0xff)
#define PLUM_RED_64(color) ((uint64_t) (color) & 0xffffu)
#define PLUM_RED_16(color) ((uint16_t) (color) & 0x1f)
#define PLUM_RED_32X(color) ((uint32_t) (color) & 0x3ff)
#define PLUM_GREEN_32(color) (((uint32_t) (color) >> 8) & 0xff)
#define PLUM_GREEN_64(color) (((uint64_t) (color) >> 16) & 0xffffu)
#define PLUM_GREEN_16(color) (((uint16_t) (color) >> 5) & 0x1f)
#define PLUM_GREEN_32X(color) (((uint32_t) (color) >> 10) & 0x3ff)
#define PLUM_BLUE_32(color) (((uint32_t) (color) >> 16) & 0xff)
#define PLUM_BLUE_64(color) (((uint64_t) (color) >> 32) & 0xffffu)
#define PLUM_BLUE_16(color) (((uint16_t) (color) >> 10) & 0x1f)
#define PLUM_BLUE_32X(color) (((uint32_t) (color) >> 20) & 0x3ff)
#define PLUM_ALPHA_32(color) (((uint32_t) (color) >> 24) & 0xff)
#define PLUM_ALPHA_64(color) (((uint64_t) (color) >> 48) & 0xffffu)
#define PLUM_ALPHA_16(color) (((uint16_t) (color) >> 15) & 1)
#define PLUM_ALPHA_32X(color) (((uint32_t) (color) >> 30) & 3)
