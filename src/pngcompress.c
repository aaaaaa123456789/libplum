...
unsigned char * emit_PNG_compressed_block (struct context * context, const struct compressed_PNG_code * restrict codes, size_t count, int custom_tree,
  ...
  *blocksize = 0;
  ...
  generate_PNG_Huffman_codes(outcodes, sizeof outcodes / sizeof *outcodes, codelengths);
  generate_PNG_Huffman_codes(outdists, sizeof outdists / sizeof *outdists, distlengths);
...
unsigned char * generate_PNG_Huffman_trees (struct context * context, uint32_t * restrict dataword, uint8_t * restrict bits, size_t * restrict size,
  ...
  generate_PNG_Huffman_tree(context, codecounts, codelengths, 0x120, 15);
  generate_PNG_Huffman_tree(context, distcounts, distlengths, 0x20, 15);
  ...
  generate_PNG_Huffman_tree(context, encodedcounts, lengths, 19, 7);
  ...
  generate_PNG_Huffman_codes(codes, 19, lengths);
...
void generate_PNG_Huffman_tree (struct context * context, const size_t * restrict counts, unsigned char * restrict lengths, size_t entries, unsigned char max) {
...
void generate_PNG_Huffman_codes (unsigned short * restrict codes, unsigned count, const unsigned char * restrict lengths) {
